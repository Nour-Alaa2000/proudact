...
import 'package:products/features/Home/presentation/bloc/proudact_bloc.dart';
import 'package:products/features/Home/presentation/widgets/ProductItem.dart';

import '../../Data/models/proudactsModel.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create:(context) => ProudactBloc(
          ...
          )..add(GetProudactEvent(),
      )

     , child: BlocBuilder<ProudactBloc, ProudactState >(
              ...
              Expanded(
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return ProductItem(
                        index: index, productModel: state.ProudactsModel);
                  },
                ),
              ),
